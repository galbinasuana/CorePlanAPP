...
const appendMainOptions = () => {
    const welcomeText = `
        ...
        <p><b>What would you like to start with?</b> Just type a keyword (like <i>workflow</i>, <i>clients</i>, or <i>reports</i>) or select a section below 👇</p>
    `;
...
document.addEventListener("change", async (e) => {
    if (e.target.id === "followup-select") {
        ...
        // Apelează direct logica existentă
        if (action === "add") {
